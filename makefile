...
TARGET = Arx.bin
OBJS = boot.o hw_io.o keyboard.o vga.o shell.o kernel.o
...
keyboard.o: src/keyboard.c include/keyboard.h include/hw_io.h
...
kernel.o: src/kernel.c include/shell.h include/vga.h
